...
class LeagueJS {
	...
	static get Summoner() {return SummonerEndpoint};
	static get ChampionMastery() {return ChampionMasteryEndpoint};
	static get Champion() {return ChampionEndpoint};
	static get League() {return LeagueEndpoint};
	static get Masteries() {return MasteriesEndpoint};
	static get Match() {return MatchEndpoint};
	static get Runes() {return RunesEndpoint};
	static get Spectator() {return SpectatorEndpoint};
	static get LolStatus() {return LolStatusEndpoint};
	static get StaticData() {return StaticDataEndpoint};
	static get ThirdPartyCode() {return ThirdPartyCodeEndpoint};
